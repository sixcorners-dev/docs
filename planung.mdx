...
<img style={{ borderRadius: '0.5rem' }} src="images/17465559931358.jpg" alt={true} />
...
<img
  style={{ borderRadius: '0.5rem' }}
   src="images/17465560692645.jpg" alt={true} />
...
<img
  style={{ borderRadius: '0.5rem' }}
   src="images/17465560899021.jpg" alt={true} />
...
<img style={{ borderRadius: '0.5rem' }} src="images/17465564805044.jpg" alt={true} />
...
<img 
  style={{ borderRadius: '0.5rem' }}
  src="images/17465565082116.jpg" alt={true} />
...
<img 
  style={{ borderRadius: '0.5rem' }}
  src="images/17465568818190.jpg" alt={true} />

- Gib hier den Inhalt/Ablauf der Phase ein.

<img 
  style={{ borderRadius: '0.5rem' }}
  src="images/17465571013797.jpg" alt={true} />
...
<img 
  style={{ borderRadius: '0.5rem' }}
  src="images/17465572170403.jpg" alt={true} />
...
<img 
  style={{ borderRadius: '0.5rem' }}
  src="images/17465573343470.jpg" alt={true} />

<img 
  style={{ borderRadius: '0.5rem' }}
  src="images/17465574055644.jpg" alt={true} />
...
<img 
  style={{ borderRadius: '0.5rem' }}
  src="images/17465575054104.jpg" alt={true} />
...
<img 
  style={{ borderRadius: '0.5rem' }}
  src="images/17465577302150.jpg" alt={true} />
...
<img 
  style={{ borderRadius: '0.5rem' }}
  src="images/17465579030912.jpg" alt={true} />

- **Einstellungen**: Füge Mitglieder hinzu und vergib die Rechte.

<img 
  style={{ borderRadius: '0.5rem' }}
  src="images/17465581346797.jpg" alt={true} />


<img 
  style={{ borderRadius: '0.5rem' }}
  src="images/17465581069926.jpg" alt={true} />
...
<img 
  style={{ borderRadius: '0.5rem' }}
  src="images/17465581633190.jpg" alt={true} />
...
<img 
  style={{ borderRadius: '0.5rem' }}
  src="images/17465582505115.jpg" alt={true} />
- Klicke auf das **Drei-Punkte-Menü** und erstelle deine **Kopie** von der Stunde.

<img 
  style={{ borderRadius: '0.5rem' }}
  src="images/17465582776805.jpg" alt={true} />
